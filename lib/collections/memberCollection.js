...
function MemberCollection(model) {
    ...
    this._onItemAdded = function(item, index) {
        item.on(ModelMember.events.valueChanging, this._onValueChanging.bind(this));
        item.on(ModelMember.events.valueChanged, this._onValueChanged.bind(this));
    }

    this._onItemRemoved = function(item, index) {
        item.off(ModelMember.events.valueChanging, this._onValueChanging.bind(this));
        item.off(ModelMember.events.valueChanged, this._onValueChanged.bind(this));
    }
}
