...
class MemberCollection extends NamedCollection {
    ...
    _registerMember(member) {
        member.on(Events.member.valueChanging, this._onMemberValueChanging.bind(this));
        member.on(Events.member.valueChanged, this._onMemberValueChanged.bind(this));
    }
    
    _unregisterMember(member) {
        member.off(Events.member.valueChanging, this._onMemberValueChanging);
        member.off(Events.member.valueChanged, this._onMemberValueChanged);
    }
    
    _onMemberValueChanging(change) {
        this.emit(Events.memberCollection.valueChanging, change);
    }
    _onMemberValueChanged(change) {
        this.emit(Events.memberCollection.valueChanged, change);     
    }
