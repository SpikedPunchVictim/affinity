...
class Field extends NamedObject.NamedObject {
    constructor(instance, member) {
        ...
        this._member.on(Member.events.valueChanged, this._onMemberValueChanged.bind(this));
        this._member.on(NamedObject.events.nameChanged, this._memberNameChanged.bind(this));
    }
    
    dispose() {
        this._member.off(Member.events.valueChanged, this._onMemberValueChanged);
        this._member.on(NamedObject.events.nameChanged, this._memberNameChanged);
    }
