...
Instance.prototype.dispose = function dispose() {
    ...
    model.members.removeListener(MemberCollection.events.added, this._onMemberAdded, this);
    model.members.removeListener(MemberCollection.events.removed, this._onMemberRemoved, this);  
}
