...
function Model(name, nspace) {
    ...
    */
    ...
    this.forward = utility.events.forward({
        events: [Model.added, Model.adding, Model.removing, Model.removing, Model.valueChanging, Model.valueChanged],
        source: this.members,
        dest: this
    });
