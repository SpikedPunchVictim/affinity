...
var events = {
    ...
    moving: MemberCollection.events.moving,
    moved: MemberCollection.events.moved,
...
class Model extends QualifiedObject {
    constructor(name, namespace) {
        ...
        this._members = new MemberCollection.MemberCollection(this);
        ...
        this._sub = this._members.sub([
            ...
            { event: MemberCollection.events.valueChanging, handler: items => self._emitEvent(events.valueChanging, items) },
            { event: MemberCollection.events.valueChanged, handler: items => self._emitEvent(events.valueChanged, items) }
        ]);
    }
