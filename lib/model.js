...
function Model(name, nspace) {
    ...
    this.members.on(MemberCollection.events.adding, this._onMembersAdding.bind(this));
    this.members.on(MemberCollection.events.removing, this._onMembersRemoving.bind(this));
