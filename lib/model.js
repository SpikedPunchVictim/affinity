...
class Model extends QualifiedObject {
    constructor(name, namespace) {
        ...
        this._sub = this._members.sub([
            { event: Events.memberCollection.adding, handler: items => self._emitEvent(Events.model.adding, items) },
            { event: Events.memberCollection.added, handler: items => self._emitEvent(Events.model.added, items) },
            { event: Events.memberCollection.moving, handler: items => self._emitEvent(Events.model.moving, items) },
            { event: Events.memberCollection.moved, handler: items => self._emitEvent(Events.model.moved, items) },
            { event: Events.memberCollection.removing, handler: items => self._emitEvent(Events.model.removing, items) },
            { event: Events.memberCollection.removed, handler: items => self._emitEvent(Events.model.removed, items) }
        ]);
