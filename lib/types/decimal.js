...
Object.defineProperty(DecimalValue.prototype, 'value', {
    get: function() {
        return this._value;
    },
    ...
    set: function(value) {
        ...
        var command = new Commands.DecimalChangeValueCommand(this, this._value, value);
        command.apply();
    }
});

DecimalValue.prototype._setValue = function _setValue(value) {
    if(value === this._value) {
        return;
    }
