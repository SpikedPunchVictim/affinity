...
Object.defineProperty(UintValue.prototype, 'value', {
    get: function() {
        return this._value;
    },
    ...
    set: function(value) {
        ...
        var command = new Commands.UintChangeValueCommand(this, this._value, value);
        command.apply();
    }
});

UintValue.prototype._setValue = function _setValue(value) {
    if(value === this._value) {
        return;
    }
...
Object.defineProperty(UintValue.prototype, 'type', {
